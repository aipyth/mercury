...
var getWeek = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(function* () {
    ...
    if (shortperiod) $('section.content .nextweek-field').addClass('hidden'); // Adding timeschemes from server to client var Weeks
    ...
    for (var subject of all_subjects_server) {
      for (var _day in subject.days_and_orders) {
        for (var order of subject.days_and_orders[_day]) {
          ...
          if (!shortperiod) Weeks[1][_day].subjects[order] = subject.name;
        }
      }
    }
  });
...
function signUpSucessful(_x9, _x10) {
  return _signUpSucessful.apply(this, arguments);
}

function _signUpSucessful() {
  _signUpSucessful = _asyncToGenerator(function* (data, password) {
...
function logINSucessful(_x11) {
  return _logINSucessful.apply(this, arguments);
}

function _logINSucessful() {
  _logINSucessful = _asyncToGenerator(function* (data) {
...
function signUp(_ref10) {
  ...
  window.fetch('/api/create-user/', {
    ...
    var _ref11 = _asyncToGenerator(function* (response) {
      return yield responseResult(response, 201, signUpSucessful, signUpFail, password);
    });
...
function write_cookie(_x14, _x15) {
  return _write_cookie.apply(this, arguments);
}

function _write_cookie() {
  _write_cookie = _asyncToGenerator(function* (name, value) {
...
function saveToken(_x16) {
  return _saveToken.apply(this, arguments);
}

function _saveToken() {
  _saveToken = _asyncToGenerator(function* (data) {
    token = data.token;
    yield write_cookie('token', token);
  });
  return _saveToken.apply(this, arguments);
}
...
function timeSchemesPost(_x17) {
  return _timeSchemesPost.apply(this, arguments);
}

function _timeSchemesPost() {
  _timeSchemesPost = _asyncToGenerator(function* (sheme_name) {
...
function createRoomPost(_x18) {
  return _createRoomPost.apply(this, arguments);
}

function _createRoomPost() {
  _createRoomPost = _asyncToGenerator(function* (room_settings) {
...
$('#submitsheme').click(() => {
  ...
  if (sheme_name != '') {
    _asyncToGenerator(function* () {
      yield timeSchemesPost(sheme_name);
      var time_shemes = yield getTimeShemes();
      log(time_shemes);
      var options = "<option> ... </option>";
...
$('#createroom').click( /*#__PURE__*/_asyncToGenerator(function* () {
  ...
  yield createRoomPost(room_settings);
  displayRooms();
  $($('.settings-content').children()[setting_id]).addClass('hidden');
  setting_id = (setting_id + 1) % number_of_settings;
  $($('.settings-content').children()[setting_id]).removeClass('hidden');
...
var getShemeName = /*#__PURE__*/function () {
  ...
  return function getShemeName(_x19) {
